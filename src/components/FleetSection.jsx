...
const FleetSection = () => {
    ...
    <div className="mt-20" id="vehicles">
        <div className="flex flex-col ps-8 items-center justify-center">
            <p className="text-4xl sm:text-5xl font-extrabold my-2 text-center">Explore our fleet of luxurious vehicles</p>
            <p className="text-2xl sm:text-3xl font-bold my-2">Diverse Vehicle Models</p>
